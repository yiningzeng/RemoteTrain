...
def performDetect(savePath= "save",imagePath="data/dog.jpg", img=None,thresh= 0.25, configPath = "./cfg/yolov3.cfg", weightPath = "yolov3.weights", metaPath= "./cfg/coco.data", showImage= True, saveImage = True, initOnly= False):
    """
