...
cfg = "/opt/yunsheng/train-7-10/yolov3-voc-test.cfg"
model = "/opt/yunsheng/train-7-10/backup/yolov3-voc_140000.weights"
data = "/opt/yunsheng/train-7-10/voc.data"
save_path = "/opt/lampp/htdocs/aiimg/" # 检测结果保存路径 以 / 结尾
img_path = "/opt/yunsheng/test-7-10/" # 检测的图片路径 以 / 结尾
    ...
    if request.method == 'POST' or request.method == 'GET':
        ...
        for i in range(len(r)):
            ...
            if r[i][1] > score:
                ...
                cv2.putText(img, str(r[i][0]) + " " + str(r[i][1]), (int(x1), int(y1)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
