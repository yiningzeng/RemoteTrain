...
import { getList, getModelList, getValPathList, getVocPathList, doTrain,
    ...
    getLabelsByProject, getLabelsWithScoreByProject, suggest_score_get, suggest_score_put } from './services/api';
        ...
        const expandedRowRender = (record) => {
            return <div>
                    ...
                    <Row>
                        ...
                        <Tabs defaultActiveKey="1" tabPosition="left" style={{ height: 820, marginTop: 20 }}>
                                        ...
                                        record.status === 0 &&  <Popconfirm
                                            ...
                                            onConfirm={() => {
                                                ...
                                                dispatch({
                                                    ...
                                                    payload: {
                                                        model_path: encodeURI(record.path),
                            ...
                            <Collapse bordered={false} onChange={(v)=>{
                                ...
                                <Collapse.Panel  header="点击重新计算推荐置信度" key="1">
                                    ...
                                    >
                                        ...
                                        <Form.Item label="单位平方分米所允许的最大误报数">
                                            <InputNumber
